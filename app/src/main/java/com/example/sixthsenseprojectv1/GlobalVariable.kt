...
val sensorNames = arrayOf("Temperature", "Humidity", "Pressure", "Altitude", "TVOC", "ECO2",
    "Luminosity", "Longitude", "Latitude", "Time", "Heart Rate", "Oxygen Saturation", "Body Temperature","Respiratory",
    "Accelerometer", "Systolic", "Diastolic")
val shortSensorNames = arrayOf("E.T.", "Hum.", "P.S.I.", "Alt.", "TVOC", "ECO2",
