...
class DBHandlerTest {
    ...
    fun addNewSensorData() {
        dbHandler.deleteAll()
        val result = dbHandler.addNewSensorData("user1", "sensor1",
    ...
    fun addNewWarningData() {
        val result = dbHandler.addNewWarningData("user1", "sensor1",
            "data1", "warning1", "time1")
        assertNotEquals(-1, result) // Check that the row was added successfully
    ...
    fun readAllData() {
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("user1", "sensor1",
            "data1", "warning1", "time1")
        dbHandler.addNewSensorData("user1", "sensor2",
            "data2", "warning2", "time2")
        dbHandler.addNewSensorData("user2", "sensor1",
    ...
    fun readLatestWarningPerSensor() {
        dbHandler.addNewSensorData("1", "Temperature",
            "data1", "warning1", "time1")
        dbHandler.addNewSensorData("1", "Temperature",
            "data2", "warning2", "time2")
        dbHandler.addNewSensorData("1", "Temperature",
