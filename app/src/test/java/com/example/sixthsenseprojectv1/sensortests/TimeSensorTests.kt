...
//This class tests each method inside of the Time sensor object
class TimeSensorTests {
    @Test
    //tests the getFromDatabase method inside the Time sensor object
    fun getFromDatabase(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("1", "Time",
            "data1", "warning1", "time1")
        val myTemp = Time(1, "Time", LocalDateTime.now(), 0,null)
        val temp = myTemp.getFromDatabase(InstrumentationRegistry.getInstrumentation().targetContext,1)
        assertEquals("data1 °",temp)
    }

    @Test
    //tests the getWarningFromDatabase method inside the Time sensor object
    ...
    @Test
    //tests the getHistorical method inside the Time sensor object
    fun getHistorical(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
    ...
    @Test
    //tests the getHistoricalWithTime method inside the Time sensor object
    ...
    @Test
    //tests the getHistoricalWarning method inside the Time sensor object
    ...
    @Test
    //tests the getLastTenMinutes method inside the Time sensor object
