...
//This class tests each method inside of the Latitude sensor object
class LatitudeSensorTests {
    @Test
    //tests the getFromDatabase method inside the Latitude sensor object
    fun getFromDatabase(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("1", "Latitude",
            "data1", "warning1", "time1")
        val myTemp = Latitude(1, "Latitude", 90, 0,null)
        val temp = myTemp.getFromDatabase(InstrumentationRegistry.getInstrumentation().targetContext,1)
        assertEquals("data1 °",temp)
    }

    @Test
    //tests the getWarningFromDatabase method inside the Latitude sensor object
    ...
    @Test
    //tests the getHistorical method inside the Latitude sensor object
    fun getHistorical(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
    ...
    @Test
    //tests the getHistoricalWithTime method inside the Latitude sensor object
    ...
    @Test
    //tests the getHistoricalWarning method inside the Latitude sensor object
    ...
    @Test
    //tests the getLastTenMinutes method inside the Latitude sensor object
