...
//This class tests each method inside of the Oxygen Saturation sensor object
class OxygenSaturationSensorTests {
    @Test
    //tests the getFromDatabase method inside the Oxygen Saturation sensor object
    fun getFromDatabase(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("1", "Oxygen Saturation",
    ...
    @Test
    //tests the getWarningFromDatabase method inside the Oxygen Saturation sensor object
    fun getWarningFromDatabase(){
        ...
        dbHandler.addNewSensorData("1", "Oxygen Saturation",
            "23", "24", "time1")
        val myTemp = OxygenSaturation(1, "Oxygen Saturation", 90, 23,null)
        val temp = myTemp.getWarningFromDatabase(InstrumentationRegistry.getInstrumentation().targetContext,1)
        assertEquals(24,temp)
    }
    @Test
    //tests the checkWarnings method inside the Oxygen Saturation sensor object
    fun checkWarnings(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAllWarning()
        val myTemp = OxygenSaturation(1, "Oxygen Saturation", 90, 23,null)
        val temp = myTemp.checkWarnings(95)
        assertEquals(0,temp)
    }

    @Test
    //tests the getHistorical method inside the Oxygen Saturation sensor object
    fun getHistorical(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
    ...
    @Test
    //tests the getHistoricalWithTime method inside the Oxygen Saturation sensor object
    ...
    @Test
    //tests the getHistoricalWarning method inside the Oxygen Saturation sensor object
    ...
    @Test
    //tests the getLastTenMinutes method inside the Oxygen Saturation sensor object
