...
//This class tests each method inside of the Respiratory sensor object
class RespiratorySensorTests {
    @Test
    //tests the getFromDatabase method inside the Respiratory sensor object
    fun getFromDatabase(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("1", "Respiratory",
            "data1", "warning1", "time1")
        val myTemp = Respiratory(1, "Respiratory", 90, 0,null)
        val temp = myTemp.getFromDatabase(InstrumentationRegistry.getInstrumentation().targetContext,1)
        assertEquals("data1 Bpm",temp)
    }

    @Test
    //tests the getWarningFromDatabase method inside the Respiratory sensor object
    ...
    @Test
    //tests the getHistorical method inside the Respiratory sensor object
    fun getHistorical(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
    ...
    @Test
    //tests the getHistoricalWithTime method inside the Respiratory sensor object
    ...
    @Test
    //tests the getHistoricalWarning method inside the Respiratory sensor object
    ...
    @Test
    //tests the getLastTenMinutes method inside the Respiratory sensor object
