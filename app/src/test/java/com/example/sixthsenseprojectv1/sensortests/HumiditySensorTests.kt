...
//This class tests each method inside of the Humidity sensor object
class HumiditySensorTests {
    @Test
    //tests the getFromDatabase method inside the Humidity sensor object
    fun getFromDatabase(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
        dbHandler.addNewSensorData("1", "Humidity",
    ...
    @Test
    //tests the getWarningFromDatabase method inside the Humidity sensor object
    ...
    @Test
    //tests the getHistorical method inside the Humidity sensor object
    fun getHistorical(){
        val dbHandler = DBHandler(context =
        InstrumentationRegistry.getInstrumentation().targetContext)
        dbHandler.deleteAll()
    ...
    @Test
    //tests the getHistoricalWithTime method inside the Humidity sensor object
    ...
    @Test
    //tests the getHistoricalWarning method inside the Humidity sensor object
    ...
    @Test
    //tests the getLastTenMinutes method inside the Humidity sensor object
